  ...
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="lang-switcher">
        <button v-for="lang in ['en', 'ru', 'zh']" :key="lang"
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          <div class="panel-header">
            <span class="status-dot">■</span> {{ $t('status.system') }}
          </div>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('workflow.step1') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('workflow.step2') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('workflow.step3') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('workflow.step4') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('workflow.step5') }}</div>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">01 / {{ $t('upload.seedLabel') }}</span>
                <span class="console-meta">{{ $t('upload.formats') }}</span>
              </div>
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">{{ $t('upload.dragDrop') }}</div>
                  <div class="upload-hint">{{ $t('upload.clickBrowse') }}</div>
                </div>
            ...
            <div class="console-divider">
              <span>{{ $t('upload.inputParams') }}</span>
            </div>

            <!-- 输入区域 -->
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ $t('upload.promptLabel') }}</span>
              </div>
              <div class="input-wrapper">
                <textarea
                  ...
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">{{ $t('upload.engine') }}</div>
              </div>
            </div>
            ...
            <div class="console-section btn-section">
              ...
              >
                <span v-if="!loading">{{ $t('upload.startEngine') }}</span>
                <span v-else>{{ $t('upload.initializing') }}</span>
