> **注意：** 本仓库是 [MiroFish](https://github.com/666ghj/MiroFish) 的多语言分支（原作者：[666ghj](https://github.com/666ghj)）。主要变更：默认语言改为英语，界面新增完整的国际化支持（EN/RU/ZH），文档提供三种语言版本。本项目继续以 [GNU AGPL-3.0](./LICENSE) 许可证分发。
